      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {capabilitiesContent.map((capability, index) => (
            ...
            >
              <Card className="h-full border border-[#EDEDED] bg-white shadow-[0px_3px_16px_0px_rgba(30,37,75,0.02),0px_2px_2px_0px_rgba(30,37,75,0.01)] hover:shadow-lg transition-shadow rounded-[20px]">
                <CardHeader>
